...
import { Trophy, Calendar, Users, DollarSign, ArrowRight, Eye } from 'lucide-react';
...
const TournamentRegistration: React.FC = () => {
  ...
  const { tournaments, loading } = useTournaments({ limit: 6, status: 'ongoing' });
        ...
        {tournaments.length === 0 ? (
          <div className="text-center space-y-8">
            <div className="bg-purple-900/20 backdrop-blur-sm rounded-xl p-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">No Active Tournaments</h3>
              <p className="text-gray-400 mb-8">
                There are currently no active tournaments. Check back later or view past tournaments.
              </p>
              <Link
                to="/all-matches"
          ...
          <>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-2 text-gray-300">
                          ...
                          <span className="text-sm">{registrationCounts[tournament.id] || 0}/{tournament.max_participants}</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-300">
            ...
            <div className="flex justify-center mt-12">
              <Link
                to="/all-matches"
                className="inline-flex items-center gap-2 px-6 sm:px-8 py-4 bg-purple-600 hover:bg-purple-700 rounded-lg text-white 
                  font-medium transition-colors group"
              >
                <span>VIEW PAST TOURNAMENTS</span>
                <ArrowRight className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" />
